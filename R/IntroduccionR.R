...
head(iris)       # dataset integrado en R. PARA VER LAS 5 PRIMERAS FILAS
tail(iris)     #saca el final 
str(iris)		#analisis estadistico 
dim(iris) 		#para sacar las dimensiones de la tabla
summary(iris)

iris$Species
iris[1:5, c("Sepal.Length", "Species")]		#filas de la 1 a la 5. columnas solo sepal length y species
